    ...
    <div className="min-h-full">
      ...
      <main>
        ...
        <div className= "flex space-x-4">
            ...
            <button onClick = {()=>setSelectedTab(0)} className="w-24 h-8 text-base flex items-center justify-center font-bold no-underline mb-3 mt-3 rounded-2xl bg-indigo-800 text-white shadow-md hover:bg-indigo-900">Users</button>
            <button onClick = {()=>setSelectedTab(1)} className="w-24 h-8 text-base flex items-center justify-center font-bold no-underline mb-3 mt-3 rounded-2xl bg-indigo-800 text-white shadow-md hover:bg-indigo-900">Tests</button>
        </div>   
