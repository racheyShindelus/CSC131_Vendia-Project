...
exports.Test__getDocument = (0, graphql_tag_1.default) `
  ...
  get_Test(id: $id, version: $version, readMode: $readMode) {
    ...
    `;
exports.Devices__getDocument = (0, graphql_tag_1.default) `
    query Devices__get($id: ID, $version: Int, $readMode: Vendia_ReadMode = NODE_COMMITTED, $DeviceName: String) {
  get_Devices(
    id: $id
    version: $version
    readMode: $readMode
...
exports.Test__listDocument = (0, graphql_tag_1.default) `
  ...
  list_TestItems(
    ...
    `;
exports.Devices__listDocument = (0, graphql_tag_1.default) `
    query Devices__list($nextToken: String, $limit: Int, $filter: Self_Devices_FilterInput_, $order: [Self_Devices_OrderInput_!], $readMode: Vendia_ReadMode = NODE_COMMITTED) {
  list_DevicesItems(
    nextToken: $nextToken
    limit: $limit
    filter: $filter
...
exports.Test__updateDocument = (0, graphql_tag_1.default) `
  ...
  update_Test(
    ...
    `;
exports.Devices__addDocument = (0, graphql_tag_1.default) `
    mutation Devices__add($input: Self_Devices_Input_!, $syncMode: Vendia_SyncMode = NODE_COMMITTED, $aclInput: Vendia_Acls_Input_) {
  add_Devices(input: $input, syncMode: $syncMode, aclInput: $aclInput) {
    transaction {
      _id
      _owner
      transactionId
    ...
    `;
exports.Devices__putDocument = (0, graphql_tag_1.default) `
    mutation Devices__put($id: ID, $DeviceName: String, $input: Self_Devices_Input_!, $syncMode: Vendia_SyncMode = NODE_COMMITTED, $condition: Self_Devices_ConditionInput_, $aclInput: Vendia_Acls_Input_!) {
  put_Devices(
    id: $id
    DeviceName: $DeviceName
    input: $input
    ...
    `;
exports.Devices__updateDocument = (0, graphql_tag_1.default) `
    mutation Devices__update($id: ID, $DeviceName: String, $input: Self_Devices_UpdateInput_!, $syncMode: Vendia_SyncMode = NODE_COMMITTED, $condition: Self_Devices_ConditionInput_, $aclInput: Vendia_Acls_Input_) {
  update_Devices(
    id: $id
    DeviceName: $DeviceName
    input: $input
...
exports.Test__removeDocument = (0, graphql_tag_1.default) `
  ...
  remove_Test(id: $id, syncMode: $syncMode, condition: $condition) {
    ...
    `;
exports.Devices__removeDocument = (0, graphql_tag_1.default) `
    mutation Devices__remove($id: ID, $DeviceName: String, $syncMode: Vendia_SyncMode = NODE_COMMITTED, $condition: Self_Devices_ConditionInput_) {
  remove_Devices(
    id: $id
    DeviceName: $DeviceName
    syncMode: $syncMode
...
exports.Test__onUpdateDocument = (0, graphql_tag_1.default) `
  ...
  onUpdate_Test {
    ...
    `;
exports.Devices__onAddDocument = (0, graphql_tag_1.default) `
    subscription Devices__onAdd {
  onAdd_Devices {
    error
    result {
      _id
    ...
    `;
exports.Devices__onRemoveDocument = (0, graphql_tag_1.default) `
    subscription Devices__onRemove {
  onRemove_Devices {
    error
    result {
      _id
    ...
    `;
exports.Devices__onUpdateDocument = (0, graphql_tag_1.default) `
    subscription Devices__onUpdate {
  onUpdate_Devices {
    error
    result {
      _id
    ...
    return {
        ...
        devices: {
            get(idOrOptions, options) {
                const variables = typeof idOrOptions === 'string' ? { ...options, id: idOrOptions } : { ...options, ...idOrOptions };
                return _requestWrapper((wrappedRequestHeaders) => {
                    return _gqlClient.request(exports.Devices__getDocument, variables, wrappedRequestHeaders)
                        .then(res => res.get_Devices);
                }, 'get_Devices');
            },
            list(options) {
                const variables = options;
                return _requestWrapper((wrappedRequestHeaders) => {
                    return _gqlClient.request(exports.Devices__listDocument, variables, wrappedRequestHeaders)
                        .then(res => { const updatedRes = { ...res.list_DevicesItems, items: res.list_DevicesItems?._DevicesItems }; delete updatedRes._DevicesItems; return updatedRes; });
                }, 'list_DevicesItems');
            },
            add(input, options) {
                const variables = { ...options, input };
                return _requestWrapper((wrappedRequestHeaders) => {
                    return _gqlClient.request(exports.Devices__addDocument, variables, wrappedRequestHeaders)
                        .then(res => res.add_Devices);
                }, 'add_Devices');
            },
            put(input, options) {
                const { _id, ...rest } = input;
                const variables = { ...options, id: _id, input: rest };
                return _requestWrapper((wrappedRequestHeaders) => {
                    return _gqlClient.request(exports.Devices__putDocument, variables, wrappedRequestHeaders)
                        .then(res => res.put_Devices);
                }, 'put_Devices');
            },
            update(input, options) {
                const { _id, ...rest } = input;
                ...
                if (!variables.id) {
                    ...
                    const uniqueKey = Object.keys(rest).find((key) => ["DeviceName"].includes(key));
                    if (uniqueKey) {
                        variables[uniqueKey] = rest[uniqueKey];
                    }
                }
                return _requestWrapper((wrappedRequestHeaders) => {
                    return _gqlClient.request(exports.Devices__updateDocument, variables, wrappedRequestHeaders)
                        .then(res => res.update_Devices);
                }, 'update_Devices');
            },
            remove(idOrOptions, options) {
                const variables = typeof idOrOptions === 'string' ? { ...options, id: idOrOptions } : { ...options, ...idOrOptions };
                return _requestWrapper((wrappedRequestHeaders) => {
                    return _gqlClient.request(exports.Devices__removeDocument, variables, wrappedRequestHeaders)
                        .then(res => res.remove_Devices);
                }, 'remove_Devices');
            },
            onAdd(handler) {
                return _subscribe({ query: exports.Devices__onAddDocument }, ({ data }) => { return handler(data.onAdd_Devices); });
            },
            onRemove(handler) {
                return _subscribe({ query: exports.Devices__onRemoveDocument }, ({ data }) => { return handler(data.onRemove_Devices); });
            },
            onUpdate(handler) {
                return _subscribe({ query: exports.Devices__onUpdateDocument }, ({ data }) => { return handler(data.onUpdate_Devices); });
            }
        }
    };
}
