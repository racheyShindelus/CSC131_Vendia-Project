...
export const Test__getDocument = gql `
  ...
  get_Test(id: $id, version: $version, readMode: $readMode) {
    ...
    `;
export const Devices__getDocument = gql `
...
export const Test__listDocument = gql `
  ...
  list_TestItems(
    ...
    `;
export const Devices__listDocument = gql `
...
export const Test__updateDocument = gql `
  ...
  update_Test(
    ...
    `;
export const Devices__addDocument = gql `
  ...
  add_Devices(input: $input, syncMode: $syncMode, aclInput: $aclInput) {
    ...
    `;
export const Devices__putDocument = gql `
  ...
  put_Devices(
    ...
    `;
export const Devices__updateDocument = gql `
...
export const Test__removeDocument = gql `
  ...
  remove_Test(id: $id, syncMode: $syncMode, condition: $condition) {
    ...
    `;
export const Devices__removeDocument = gql `
...
export const Test__onUpdateDocument = gql `
  ...
  onUpdate_Test {
    ...
    `;
export const Devices__onAddDocument = gql `
  ...
  onAdd_Devices {
    ...
    `;
export const Devices__onRemoveDocument = gql `
  ...
  onRemove_Devices {
    ...
    `;
export const Devices__onUpdateDocument = gql `
    ...
    return {
        ...
        devices: {
            get(idOrOptions, options) {
                const variables = typeof idOrOptions === 'string' ? { ...options, id: idOrOptions } : { ...options, ...idOrOptions };
                return _requestWrapper((wrappedRequestHeaders) => {
                    return _gqlClient.request(Devices__getDocument, variables, wrappedRequestHeaders)
            ...
            list(options) {
                const variables = options;
                return _requestWrapper((wrappedRequestHeaders) => {
                    return _gqlClient.request(Devices__listDocument, variables, wrappedRequestHeaders)
            ...
            add(input, options) {
                const variables = { ...options, input };
                return _requestWrapper((wrappedRequestHeaders) => {
                    return _gqlClient.request(Devices__addDocument, variables, wrappedRequestHeaders)
            ...
            put(input, options) {
                ...
                const variables = { ...options, id: _id, input: rest };
                return _requestWrapper((wrappedRequestHeaders) => {
                    return _gqlClient.request(Devices__putDocument, variables, wrappedRequestHeaders)
            ...
            update(input, options) {
                ...
                return _requestWrapper((wrappedRequestHeaders) => {
                    return _gqlClient.request(Devices__updateDocument, variables, wrappedRequestHeaders)
            ...
            remove(idOrOptions, options) {
                const variables = typeof idOrOptions === 'string' ? { ...options, id: idOrOptions } : { ...options, ...idOrOptions };
                return _requestWrapper((wrappedRequestHeaders) => {
                    return _gqlClient.request(Devices__removeDocument, variables, wrappedRequestHeaders)
                        .then(res => res.remove_Devices);
                }, 'remove_Devices');
            },
            onAdd(handler) {
                return _subscribe({ query: Devices__onAddDocument }, ({ data }) => { return handler(data.onAdd_Devices); });
            },
            onRemove(handler) {
                return _subscribe({ query: Devices__onRemoveDocument }, ({ data }) => { return handler(data.onRemove_Devices); });
            },
            onUpdate(handler) {
                return _subscribe({ query: Devices__onUpdateDocument }, ({ data }) => { return handler(data.onUpdate_Devices); });
            }
        }
    };
}
